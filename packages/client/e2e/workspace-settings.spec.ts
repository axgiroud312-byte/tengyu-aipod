...
test.describe('workspace settings', () => {
  ...
  test('organizes three state-preserving settings views before unlocking production', async () => {
    ...
    const generalSettings = settings.getByRole('region', { name: '常规设置' })
    ...
    const modelSettings = settings.getByRole('region', { name: '模型与工作流设置' })
    ...
    const chenyuSettings = settings.getByRole('region', { name: '晨羽智云设置' })
